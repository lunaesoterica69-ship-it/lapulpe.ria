...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://achiev-meritocracy.preview.emergentagent.com')
...
class TestGoogleOAuthEndpoint:
    ...
    def test_google_auth_url_with_preview_domain(self):
        ...
        redirect_uri = "https://achiev-meritocracy.preview.emergentagent.com/auth/callback"
        response = requests.get(f"{BASE_URL}/api/auth/google/url", params={"redirect_uri": redirect_uri})
