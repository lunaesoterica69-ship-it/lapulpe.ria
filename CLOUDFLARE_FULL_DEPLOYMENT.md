...
- Agregar: `REACT_APP_BACKEND_URL = https://premium-grocery-1.preview.emergentagent.com`
- Redeploy
...
**Ya está configurado:**
- URL: `https://premium-grocery-1.preview.emergentagent.com`
...
[App] REACT_APP_BACKEND_URL: https://premium-grocery-1.preview.emergentagent.com
...
[AuthContext] URL del backend: https://premium-grocery-1.preview.emergentagent.com/api/auth/session
...
2. Verificar que el backend esté accesible:
   ```bash
   curl https://premium-grocery-1.preview.emergentagent.com/api/ads/plans
   ```
...
Frontend: https://la-pulperia.pages.dev
          https://www.lapulperiahn.shop
Backend:  https://premium-grocery-1.preview.emergentagent.com
