...
- Agregar: `REACT_APP_BACKEND_URL = https://pulpito-delivery.preview.emergentagent.com`
- Redeploy
...
**Ya está configurado:**
- URL: `https://pulpito-delivery.preview.emergentagent.com`
...
[App] REACT_APP_BACKEND_URL: https://pulpito-delivery.preview.emergentagent.com
...
[AuthContext] URL del backend: https://pulpito-delivery.preview.emergentagent.com/api/auth/session
...
2. Verificar que el backend esté accesible:
   ```bash
   curl https://pulpito-delivery.preview.emergentagent.com/api/ads/plans
   ```
...
Frontend: https://la-pulperia.pages.dev
          https://www.lapulperiahn.shop
Backend:  https://pulpito-delivery.preview.emergentagent.com
