...
- Agregar: `REACT_APP_BACKEND_URL = https://lapulperia-web.preview.emergentagent.com`
- Redeploy
...
**Ya está configurado:**
- URL: `https://lapulperia-web.preview.emergentagent.com`
...
[App] REACT_APP_BACKEND_URL: https://lapulperia-web.preview.emergentagent.com
...
[AuthContext] URL del backend: https://lapulperia-web.preview.emergentagent.com/api/auth/session
...
2. Verificar que el backend esté accesible:
   ```bash
   curl https://lapulperia-web.preview.emergentagent.com/api/ads/plans
   ```
...
Frontend: https://la-pulperia.pages.dev
          https://www.lapulperiahn.shop
Backend:  https://lapulperia-web.preview.emergentagent.com
