...
- Agregar: `REACT_APP_BACKEND_URL = https://achiev-meritocracy.preview.emergentagent.com`
- Redeploy
...
**Ya está configurado:**
- URL: `https://achiev-meritocracy.preview.emergentagent.com`
...
[App] REACT_APP_BACKEND_URL: https://achiev-meritocracy.preview.emergentagent.com
...
[AuthContext] URL del backend: https://achiev-meritocracy.preview.emergentagent.com/api/auth/session
...
2. Verificar que el backend esté accesible:
   ```bash
   curl https://achiev-meritocracy.preview.emergentagent.com/api/ads/plans
   ```
...
Frontend: https://la-pulperia.pages.dev
          https://www.lapulperiahn.shop
Backend:  https://achiev-meritocracy.preview.emergentagent.com
