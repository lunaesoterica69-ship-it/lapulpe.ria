    ...
    <div className="min-h-screen bg-stone-950 overflow-hidden relative">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6">
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-3 mb-4">
            <PulperiaLogo className="w-12 h-12" />
          ...
          <button
            ...
            onClick={handleLogin}
            className="group inline-flex items-center gap-3 bg-red-600 hover:bg-red-500 text-white font-medium py-3.5 px-8 rounded-xl transition-all"
          >
            ...
            Comenzar con Google
            <ArrowRight className="w-4 h-4 opacity-50 group-hover:translate-x-0.5 group-hover:opacity-100 transition-all" />
          </button>
      ...
      <footer className="absolute bottom-0 left-0 right-0 z-10 px-6 py-4">
        <div className="flex items-center justify-center gap-4 text-stone-600 text-xs">
          ...
          <span>•</span>
          <a href="mailto:onol4sco05@gmail.com" className="hover:text-stone-400 transition-colors">
            Contacto
          </a>
        </div>
      </footer>
