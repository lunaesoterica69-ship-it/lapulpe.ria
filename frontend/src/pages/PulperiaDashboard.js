...
import { Store as StoreIcon, Package, Plus, Edit, Trash2, Bell, Briefcase, Palette, Type, Megaphone, Image, MessageSquare, Shield, Clock, MapPin, Phone, Check, Share2, Copy, ExternalLink, Award, RefreshCw, AlertTriangle, XCircle } from 'lucide-react';
...
const PulperiaDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-stone-950 pb-24">
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-stone-950 border-stone-800">
          ...
          <form onSubmit={handleCreatePulperia} className="space-y-5 mt-2">
            ...
            <div className="pt-4 border-t border-stone-800">
              ...
              {/* Botón para cerrar tienda (solo en modo edición) */}
              {editingPulperia && (
                <div className="mt-6 pt-4 border-t border-red-900/50">
                  <Button 
                    ...
                    className="w-full text-red-400 hover:text-red-300 hover:bg-red-900/30 border border-red-900/50 py-3"
                  >
                    <XCircle className="w-4 h-4 mr-2" />
                    Cerrar Mi Tienda Permanentemente
                  </Button>
                  <p className="text-center text-xs text-stone-500 mt-2">
                    Esta acción eliminará tu pulpería y todos sus datos
                  </p>
                </div>
              )}
            </div>
      ...
      {/* Dialog de confirmación para cerrar tienda */}
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <Button
                ...
                disabled={isClosingStore || closeConfirmation.trim().toLowerCase() !== selectedPulperia?.name?.trim().toLowerCase()}
